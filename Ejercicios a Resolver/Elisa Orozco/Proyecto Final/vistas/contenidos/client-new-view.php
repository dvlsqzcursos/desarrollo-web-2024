<div class="full-box page-header">
	...
	Bienvenido al registro de nuevos clientes 🌟

En esta sección, puedes agregar la información de los clientes que se unen a nuestra base de datos. Asegúrate de completar todos los campos relevantes para mantener un registro preciso.
	</p>
</div>
				...
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[0-9-]{1,27}" class="form-control" name="cliente_dpi_reg" id="cliente_dpi" maxlength="27">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
