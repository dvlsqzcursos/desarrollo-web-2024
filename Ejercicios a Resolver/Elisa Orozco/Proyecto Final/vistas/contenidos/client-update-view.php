...
<div class="full-box page-header">
	...
	Bienvenido al registro de actualización de clientes 🌟

En esta sección, puedes mantener la información de los clientes actualizada. Asegúrate de revisar y modificar los datos relevantes para garantizar que nuestros registros estén siempre al día.
	</p>
</div>
				...
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="cliente_dpi" class="bmd-label-floating">DPI</label>
							<input type="text" pattern="[0-9-]{1,27}" class="form-control" name="cliente_dpi_up" value="<?php echo $campos['cliente_dpi']; ?>" id="cliente_dpi" maxlength="27">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
