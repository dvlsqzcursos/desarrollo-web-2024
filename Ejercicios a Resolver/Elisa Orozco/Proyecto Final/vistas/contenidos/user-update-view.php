...
<div class="full-box page-header">
	...
	Bienvenido al registro de actualización de usuarios 🌟

En esta sección, puedes mantener la información de los usuarios actualizada. Asegúrate de revisar y modificar los detalles relevantes para garantizar que nuestros registros estén siempre al día.
	</p>
</div>
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_dpi" class="bmd-label-floating">DPI</label>
							<input type="text" pattern="[0-9-]{1,20}" class="form-control" name="usuario_dpi_up" value="<?php echo $campos['usuario_dpi']; ?>" id="usuario_dpi" maxlength="20">
						</div>
					</div>
