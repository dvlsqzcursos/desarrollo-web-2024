...
<div class="full-box page-header">
	...
	Bienvenido al sistema interno de usuarios 🌟

En esta sección, puedes registrar nuevos usuarios en nuestro sistema. Asegúrate de completar todos los detalles relevantes para que puedan acceder y utilizar las herramientas necesarias.
	</p>
</div>
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" pattern="[0-9-]{1,20}" class="form-control" name="usuario_dpi_reg" id="usuario_dpi" maxlength="20" required="">
						</div>
					</div>
