<div class="full-box page-header">
    ...
    Bienvenido al registro de nuevos préstamos 🌟

En esta sección, puedes registrar los detalles de los préstamos recién solicitados. Asegúrate de completar toda la información relevante para mantener nuestros registros precisos y ofrecer un excelente servicio a nuestros clientes.
    </p>
</div>
            ...
            <div>
                ...
                <?php }else{ ?> 
      			<form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="loans" enctype="multipart/form-data" autocomplete="off" style="display: inline-block !important;">
                	...
                	<?php echo $_SESSION['datos_cliente']['Nombre']." ".$_SESSION['datos_cliente']['Apellido']." (".$_SESSION['datos_cliente']['DPI'].")"; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="form-group">
                        <label for="input_cliente" class="bmd-label-floating">DPI, Nombre, Apellido, Telefono</label>
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="detalle_costo_tiempo" class="bmd-label-floating">Costo por 1 unidad de tiempo</label>
