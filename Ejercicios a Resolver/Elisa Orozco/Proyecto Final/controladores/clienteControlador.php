<?php
    ...
    class clienteControlador extends clienteModelo{
        ...
        public function agregar_cliente_controlador(){
            ...
            $dpi=mainModel::limpiar_cadena($_POST['cliente_dpi_reg']);
            ...
            if($dpi=="" || $nombre=="" || $apellido=="" || $telefono=="" || $direccion==""){
                $alerta=[
					"Alerta"=>"simple",
            ...
            if(mainModel::verificar_datos("[0-9-]{1,27}",$dpi)){
                $alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Ocurrió un error inesperado",
            ...
            /*== Comprobando DPI ==*/
            $check_dpi=mainModel::ejecutar_consulta_simple("SELECT cliente_dpi FROM cliente WHERE cliente_dpi='$dpi'");
		...
		public function paginador_cliente_controlador($pagina,$registros,$privilegio,$url,$busqueda){
			...
			if(isset($busqueda) && $busqueda!=""){
				$consulta="SELECT SQL_CALC_FOUND_ROWS * FROM cliente WHERE cliente_dpi LIKE '%$busqueda%' OR cliente_nombre LIKE '%$busqueda%' OR cliente_apellido LIKE '%$busqueda%' OR cliente_telefono LIKE '%$busqueda%' ORDER BY cliente_nombre ASC LIMIT $inicio,$registros";
			}else{
        ...
        public function actualizar_cliente_controlador(){
            ...
            $dpi=mainModel::limpiar_cadena($_POST['cliente_dpi_up']);
