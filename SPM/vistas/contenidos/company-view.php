<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-building fa-fw"></i> &nbsp; ACERCA DE ODL
    </h3>
    <p class="text-justify">
        ODL es la encargada de desarrollar este sistema, todo lo que aca se muestra es producto de muchos videos vistos jajaja.
    </p>
</div>
<?php
